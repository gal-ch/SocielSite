...
# class SitterProfileAPIView(generics.CreateAPIView):
#     lookup_field = 'pk'
#     serializer_class = SitterProfileSerializer
#
#     def perform_queryset(self):
#         return SitterProfile.objects.all()
#
...
#     schema = AutoSchema(
#         manual_fields=[
#             coreapi.Field("user", required=True,
#                           schema=coreschema.Integer(description="Foreign Key, should be user ID.")),
...
#             coreapi.Field("specialization", required=False, schema=coreschema.String(
#                 description='This is particularly for Chef. In which food items he/she expertise.')),
...
#             coreapi.Field("driving_license", required=False,
#                           schema=coreschema.String(description='Especially for Delivery person.')),
#             coreapi.Field("license_plate", required=False,
#                           schema=coreschema.String(description='Especially for Delivery person.')),
#             coreapi.Field("delivery_method", required=False, schema=coreschema.Integer(
#                 description='Especially for Delivery person. "0"-Walk, "1"-Bicycle, "2"-Motorcycle')),
#         ]
#     )
#
#     def post(self, request, *args, **kwargs):
